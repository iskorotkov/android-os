...
Google предоставляет отличную [документацию](https://developer.android.com/) по разработке под Android. Для других фреймворков (Flutter, React Native и т. д.) есть подобные документации.
